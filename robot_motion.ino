...
//follow wall
double  p_1_1 , p_1_2 , p_2_1 , p_2_2;
double  u_fw_t_1 , u_fw_t_2 , u_fw_tp_1 , u_fw_tp_2 , u_a_1 , u_a_2;
double  u_fw_p_1, u_fw_p_2 , u_fw_pp_1 , u_fw_pp_2 , u_fw_1 , u_fw_2 ;
double theta_fw;
...
int flag = 1, d_at_obs = 55, d_unsafe = 45;
int pwm_max = 0;
int d_fw = 45;
double alpha = 0.001;//0.2;
void loop() {
  t.update();
  if (flag)
  {
...
void go_to_goal_ao()
{
  ...
  u_fw_t_1 = p_2_1 - p_1_1;
  u_fw_t_2 = p_2_2 - p_1_2;

  u_fw_tp_1 = u_fw_t_1 / (sqrt((u_fw_t_1 * u_fw_t_1) + (u_fw_t_2 * u_fw_t_2)));
  u_fw_tp_2 = u_fw_t_2 / (sqrt((u_fw_t_1 * u_fw_t_1) + (u_fw_t_2 * u_fw_t_2)));

  u_a_1 = p_1_1;
  u_a_2 = p_1_2;

  u_fw_p_1 = ((u_a_1 - x) - ((u_a_1 - x) * u_fw_tp_1) * u_fw_tp_1);
  u_fw_p_2 = ((u_a_2 - y) - ((u_a_2 - y) * u_fw_tp_2) * u_fw_tp_2);

  u_fw_pp_1 = u_fw_p_1 / (sqrt((u_fw_p_1 * u_fw_p_1) + (u_fw_p_2 * u_fw_p_2)));
  u_fw_pp_2 = u_fw_p_2 / (sqrt((u_fw_p_1 * u_fw_p_1) + (u_fw_p_2 * u_fw_p_2)));

  u_fw_1 = d_fw * u_fw_tp_1 + (u_fw_p_1 - d_fw * u_fw_pp_1);
  u_fw_2 = d_fw * u_fw_tp_2 + (u_fw_p_2 - d_fw * u_fw_pp_2);

  theta_fw = atan2(u_fw_2, u_fw_1);
